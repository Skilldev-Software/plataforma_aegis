...
[
  {
    ...
    [
      ...
      { label: 'Tipo de operação da empresa:', name:'tipo_operacao', type: 'select', 
        opcs: 
        [
          { label: 'Capital de Giro Aval', icon: 'FaHandHoldingUsd', value:'cap_giro_aval' },
          { label: 'Capital de Giro com garantia', icon: 'FaShieldAlt', value:'cap_giro_garantia' },
          { label: 'Antecipação de recebíveis', icon: 'FaMoneyCheckAlt', value:'ant_recebiveis' },
          { label: 'Antecipação de Contrato', icon: 'FaFileSignature', value:'ant_contrato' },
          { label: 'Antecipação a fornecedor', icon: 'FaTruckLoading', value:'ant_fornecedor' },
          { label: 'Financiamento de Frota', icon: 'FaTruck', value:'fin_frota' },
          { label: 'Financiamento de Infraestrutura', icon: 'FaBuilding', value:'fin_infra' },
          { label: 'Conta Garantida', icon: 'FaLock', value:'conta_garantida' },
          { label: 'Câmbio', icon: 'FaExchangeAlt', value:'cambio' }
        ]
      },
  ...
  },
  {
    ...
    [
      ...
      { label: 'CNH ou RG dos sócios:', type: 'file', name: 'CNH-RG Sócios' },
      { label: 'IRPF dos sócios (mais recente):', type: 'file', name: 'IRPF Sócios' },
